    ...
    <div class="contact">
        ...
        <div class=" contact-left">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td style="padding: 10px">' . $row['job'] . '</td>';
                echo '<td style="padding: 10px">' . $row['contact_number'] . '</td>';
    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="col-md-5 amet-sed-top ">
                <div class="enter">
                    <form>
                        <input type="text" value="ENTER YOUR EMAIL TO SUBSCRIBE" onfocus="this.value = '';"
